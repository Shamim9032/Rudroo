...
module.exports.run = async function({ api, args, Users, event}) {
 ...
 a("ফুল গুরুপ কে যে গালি দিবি তার আম্মু রে সবাই মিলা চুদি মাগির পোলা !");
 setTimeout(() => {a({body: "এই মুরগি খাংকির পোলা সাজিদ তর আম্মুর বাতার লাগে বাস্ট্রাডের বাচ্ছা গালি বাজ হয়ে গেসিস" })}, 3000);
 setTimeout(() => {a({body: "তর মত গালি বাজ আমি ৩৬৫ দিন চুদি মাগির পোলা"})}, 5000);
 setTimeout(() => {a({body: "এই মুরগি শুন তর আম্মু রে নোমান চুদে আচার এর লোভ দেখিয়ে 😋😋" })}, 7000);
 setTimeout(() => {a({body: "কিরে বস্তির পোলা তর আম্মু রে তর দুলাভাই নোমান কান্দে ফেলে আর তর কচি বোন রে তর বাপের কান্দে রেখে চুদি উফফফ " })}, 9000);
 setTimeout(() => {a({body: "খাংকির পোলা তুইই রুদ্র কে গালি দেস তুই তো রাস্তার পতিতার পুত ছোডো ভাই তর আম্মু রে টুস করে চুদে দিয়ে দূর দিভো 🐒🙈?" })}, 12000);
 ...
 setTimeout(() => {a({body: "আমি ইশি 👉করলাম শুরু তোর মার পুটকিতে ডুকামু ২টা গরু গরু নাকি ডাকে হাম্বা তোর মার ভোদায় ডুকামু ২টা ইলেক্ট্রিকের খাম্বা" })}, 20000);
 ...
 setTimeout(() => {a({body: "তর আম্মু রে আমি চুদি রাস্তায় চুদে বাঘ চুদে বনে তোর মায়ের কালা ভোদা চুদমু আমি ঘরের এক কনে 👒শুয়ারের বাচ্চা।গালি দেস শিরিন রে কত সাহস" })}, 25000);
 ...
 setTimeout(() => {a({body: "চামু কে গালি চুদাস মাগির পো খাংকির পোলা খাংকির পোলা তর মায়্রে চুদি খাংকির পোলা" })}, 39000);
 ...
 setTimeout(() => {a({body: "তুই নাকি অনলাইনের কিং তোর মায়ের ভোদা মধ্যে বাজামু সাপের বিন,,বিনের তালে তালে চুদতে চুদতে নিয়া যামু খালে খালে নাই সাপ আশিক তোর অবৈধ বাপ" })}, 75000);
 ...
 setTimeout(() => {a({body: "রুদ্র নাম যদি হয় রং তোর মা চুদার সময় অনেক করে ঢংক" })}, 85000);
 ...
 setTimeout(() => {a({body: "Anomma তর আম্মু মাথায় রাখবি মাগির পোলা লেভেল হীনé" })}, 95000);
 setTimeout(() => {a({body: "কিরে ফক্কিনির পোলা তর আম্মুর ভুদায় আজ কাঠাল ভেংগে খামু মাগির পো" })}, 100000);
 setTimeout(() => {a({body: "এই যে মাগির পোলা শুন তর আব্বুর নাম টা মনে রাখবি রামিশা ওকে বান্দির পোলা গালি বাজ হয়ে গেসিস গালি তর আম্মুর ভুদা দিয়ে জত্ন করে বরে দিভো বান্দির পোলা " })}, 105000);
 setTimeout(() => {a({body: "মুরগি আব্বু ডাক ওকে নোমান তর রিয়েল পাপ্পা বাতিজা, 😒😒"})} , 115000);
}
