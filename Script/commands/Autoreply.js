...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "admin": "SHE IS ISHIKA  তাকে সবাই Admin ISHIKA হিসেবে চিনে😘☺️",
    "babi": "এ তো হাছিনা হে মেরে দিলকি দারকান হে মেরি জান হে😍.",
    "chup": "তুই চুপ চুপ কর পাগল ছাগল",
    "Assalamualaikum": "Walaikumassalam❤️‍🩹",
    "fork": "দুরে গিযে মুরি খা নাইলে বস রুদ্র কে রিকোয়েস্ট কর",
    "kiss me": "তুমি পঁচা তোমাকে কিস দিবো না 🤭",
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস রুদ্র রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস রুদ্র এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss রুদ্র এর ইনবক্সে গুতা দিন 😘",
    ...
    "tor nam ki": "MY NAME IS ─𝐑𝐎𝐒𝐄 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
